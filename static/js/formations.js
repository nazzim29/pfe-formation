        ...
        <div class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
            <div class="p-4">
                ...
                ${f.activite
                  .map((e) => {
                    return `<span
                    class="inline-block px-2 py-1 leading-none bg-yellow-400 text-yellow-600 rounded-full font-semibold uppercase tracking-wide text-xs">${e}</span>`;
                  })
                  .join("")}
            ...
            <div class="flex items-center justify-center">
                <button class="w-full h-full text-bold hover:bg-atblue-light focus:bg-atblue outline-none focus:outline-none px-2 py-1">Postuler</button>
            </div>
        </div>
    </div>`;
};
...
const afficher = (e) => {
  if(!e) return cardContainer.html(`
